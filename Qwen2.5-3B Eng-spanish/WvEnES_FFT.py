...
save_root = "/scratch/yl258/kp759/llQwen2.5-3B/results_eng_es_fft_fast"
...
# Faster eval cadence
EVAL_ES_EVERY = 2   # evaluate Spanish test every 2 epochs
...
candidate_tokens = get_candidate_new_tokens(
    spanish_train_sents_all, base_tokenizer, top_k=NUM_NEW_TOKENS, min_freq=MIN_WORD_FREQ, min_len=MIN_WORD_LEN
)
...
for K in K_CONFIGS:
    train_sents = spanish_train_sents_all[:K]
